package com.elhady.mymovies.fragment.upcoming;
...
public class UpComingMovieFragment extends Fragment {
    ...
    private String upcoming = MovieClient.UPCOMING;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.up_coming_movie_activity, container, false);
        movieClient = MovieClient.getInstance();

        recyclerView = root.findViewById(R.id.up_coming_movie_rv);
    ...
    private void getMovies(int page) {
        ...
        movieClient.getMovies(page, upcoming, new OnGetMoviesCallback() {
            @Override
