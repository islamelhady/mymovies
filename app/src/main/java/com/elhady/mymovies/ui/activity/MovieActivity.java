package com.elhady.mymovies.ui.activity;
...
public class MovieActivity extends AppCompatActivity {
    ...
    private void getMovie() {
        movieClient.getMovie(movieId, new OnGetMovieCallback() {
            @Override
    ...
    private void getTrailers(Movie movie) {
        movieClient.getTrailers(movie.getId(), new OnGetTrailersCallback() {
            @Override
    ...
    private void getReviews(Movie movie) {
        movieClient.getReviews(movie.getId(), new OnGetReviewsCallback() {
            @Override
